...
<div class="mx-auto max-w-3xl">
    ...
    <div class="mb-6 mt-3">
        ...
        <p class="mt-1 text-gray-500">
            Izveido jaunu galveno kategoriju vai apakškategoriju.
        </p>
    ...
    <form
        ...
        <div class="mb-6">
            ...
            <p class="mt-2 text-sm text-gray-400">
                Atstāj tukšu, ja vēlies izveidot galveno kategoriju.
            </p>
        ...
        <div>
            ...
            <textarea
                ...
                class="w-full resize-none rounded-lg border border-gray-300 px-4 py-3 outline-none focus:border-blue-500">{{ old('description') }}</textarea>
