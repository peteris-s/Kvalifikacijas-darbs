...
<div class="mx-auto max-w-3xl">
    ...
    <div class="mb-8 mt-5">
        ...
        <p class="mt-2 text-sm text-slate-500 dark:text-slate-400">
            Maini preces informāciju, noliktavas atlikumu un atrašanās vietu.
        </p>
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="mt-0.5 text-xs text-slate-500 dark:text-slate-400">
                        Rediģē pamatinformāciju un noliktavas parametrus
                    </p>
        ...
        <div class="p-6 sm:p-8">
            ...
            <div>
                ...
                @if($product->image)
                    ...
                    <!-- CURRENT IMAGE -->
                    <div class="mb-4 flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-emerald-400/10 dark:bg-[#091512]">

                        <img
                            src="{{ asset('storage/' . $product->image) }}"
                            alt="{{ $product->name }}"
                            class="h-20 w-20 shrink-0 rounded-xl border border-slate-200 object-cover dark:border-emerald-400/10"
                        >

                        <div>

                            <div class="mb-1 inline-flex items-center gap-1.5 rounded-full bg-emerald-100 px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.08em] text-emerald-700 dark:bg-emerald-400/10 dark:text-emerald-300">
                            ...
                            <p class="mt-0.5 text-xs text-slate-400 dark:text-slate-500">
                                Augšupielādē jaunu failu tikai tad, ja vēlies attēlu nomainīt.
                            </p>
                ...
                @else
                    ...
                    <!-- NO IMAGE -->
                    <div class="mb-4 flex items-center gap-3 rounded-xl border border-dashed border-slate-200 bg-slate-50 p-4 dark:border-emerald-400/10 dark:bg-[#091512]">

                        <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-slate-100 text-slate-400 dark:bg-white/[0.05] dark:text-slate-500">
                        ...
                        <div>
                            ...
                            <p class="mt-0.5 text-xs text-slate-400 dark:text-slate-500">
                                Zemāk vari pievienot preces attēlu.
                            </p>
