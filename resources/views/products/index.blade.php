            ...
            <div>
                ...
                <select
                    ...
                    <option
                        ...
                        Cena: augstākā vispirms
                    </option>

                    <option
                        value="quantity_asc"
                        @selected(request('sort') === 'quantity_asc')>

                        Atlikums: mazākais vispirms
                    </option>

                    <option
                        value="quantity_desc"
                        @selected(request('sort') === 'quantity_desc')>

                        Atlikums: lielākais vispirms
                    </option>
                            ...
                            <td
                                ...
                                @if(request()->hasAny(['search', 'category', 'stock', 'sort']))
                                    ...
                                    <p class="mt-1 text-sm text-slate-400 dark:text-slate-500">
                                        Pamēģini mainīt meklēšanas, filtra vai kārtošanas parametrus.
                                    </p>

                                    <a
                                        href="{{ route('products.index') }}"
                                        class="mt-4 inline-flex rounded-lg bg-slate-100 px-3 py-2 text-xs font-bold text-slate-700 transition hover:bg-emerald-100 hover:text-emerald-700 dark:bg-white/[0.05] dark:text-slate-300 dark:hover:bg-emerald-400/10 dark:hover:text-emerald-300">
                                ...
                                @else
                                    ...
                                    @if(auth()->user()->isAdmin())
                                        ...
                                        <a
                                            href="{{ route('products.create') }}"
                                            class="mt-5 inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-400 px-5 py-3 text-sm font-bold text-[#07110f] shadow-sm transition hover:bg-emerald-300">
